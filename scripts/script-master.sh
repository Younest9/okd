...
sudo coreos-installer install /dev/sda -I http://172.20.9.153:8080/okd/master.ign -u http://172.20.9.153:8080/okd/fcos --insecure --insecure-ignition --copy-network